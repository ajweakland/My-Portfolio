  ...
  return (
    <footer className="bg-[#1A1A1A] text-gray-400 py-8">
      <div className="container mx-auto px-6 text-center ">
        ...
        <p className="flex flex-row gap-6 justify-center mt-4">
          <a href="https://www.linkedin.com/in/alex-weakland/" target="_blank" className="hover:text-white" rel="noopener noreferrer" title="LinkedIn">
          ...
          <a href="https://github.com/ajweakland" target="_blank" className="hover:text-white" rel="noopener noreferrer" title="GitHub">
